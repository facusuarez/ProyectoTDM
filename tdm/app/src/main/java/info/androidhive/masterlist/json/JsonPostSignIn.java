...
public class JsonPostSignIn extends AsyncTask<String, Void, Void> {

    private UserInfo newUser;
    private Context context;

    public JsonPostSignIn(UserInfo newUser, Context context) {
    ...
    protected Void doInBackground(String... strings) {
        ...
        Log.i("JsonPostSignIn","Trying to get an user");
