...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE \"comentario\" (\"id_comentario\" INTEGER PRIMARY KEY AUTOINCREMENT,\"id_profesor\" INTEGER NOT NULL,\"descripcion\" TEXT NOT NULL,\"fecha_hora\" DATETIME NOT NULL,\"id_usuario\" INTEGER NOT NULL, FOREIGN KEY (id_profesor) REFERENCES profesores(id_profesor),FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario))");
